...
const displayInfo = `A total of $${totalRaised} has been raised for ${numGames} games. ${unfundedGames} ${unfundedGames <= 1 ? "game" : "games"} remains unfunded. Please help fund these games.`;

// create a new DOM element containing the template string and append it to the description container
const newParagraph = document.createElement('p');

newParagraph.innerHTML = displayInfo;
...
firstWord.innerHTML = `Most funded game ${first.name}`;
...
secondWord.innerHTML = `Second most funded game ${second.name}`;
